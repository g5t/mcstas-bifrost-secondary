...
WHEN noBS && @C==cassette AT (0, 0, 0) RELATIVE PREVIOUS ROTATED (0, -TAS[@A], 0) RELATIVE PREVIOUS
EXTEND %{
noBS = (SCATTERED) ? 0 : 1;
...
COMPONENT DetAngle@C@A = Arm() WHEN @C==cassette && @A==analyzer AT (0, 0, 0) RELATIVE AnaPoint@C@A ROTATED (0, -(2*TAS[@A]), 0) RELATIVE AnaArm@C@A
// =================================== DETECTOR ==================================== 
